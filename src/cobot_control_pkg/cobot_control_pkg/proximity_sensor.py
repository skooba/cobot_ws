#!/usr/bin/env python3
"""Proximity sensor simulation node for robot distance monitoring."""
...
class ProximitySensorNode(Node):
    """ROS2 node that simulates a proximity sensor with configurable parameters."""

    def __init__(self):
        """Initialize the proximity sensor node with default parameters."""
    ...
    def publish_proximity_data(self) -> None:
        """
        Simulate a random proximity reading and publish the reading.

        Publishes the reading to the 'proximity_distance' topic.
        """
